"""
لاگر مشترک برای همه‌ی اکسپریمنت‌ها.
- ذخیره‌ی لاگ متنی (train_log.txt)
- ذخیره‌ی metrics.csv (ماتریس دقت‌ها)
- ذخیره‌ی lambda_stats.csv (آمار λ per layer per task)
- ذخیره‌ی reg_loss.csv (ریگولاریزیشن)
- ذخیره‌ی config.json
"""
...
class ExperimentLogger:
    def __init__(self, run_dir: str):
        ...
        # اگر فایل‌های CSV وجود نداشتن، هدرشون رو بنویس
